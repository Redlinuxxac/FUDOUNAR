...
<div class="p-6">
    <div class="mb-6">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item>Editar Artículo</flux:breadcrumbs.item>
        </flux:breadcrumbs>
    </div>

    <div class="max-w-5xl">
        <div class="mb-6">
            <flux:heading size="xl" level="1">Editar Artículo</flux:heading>
            <flux:subheading>Modifica el contenido o configuración del artículo.</flux:subheading>
        </div>
