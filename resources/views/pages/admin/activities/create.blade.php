...
new #[Layout('layouts.app')] class extends Component {
    ...
    public function save()
    {
        ...
        Activity::create([
            ...
            'image' => $imagePath ?: 'https://image.pollinations.ai/prompt/humanitarian-activity-realistic?width=800&height=600&seed=' . rand(1, 1000),
        ]);

        Flux::toast('Actividad creada correctamente.');
...
<div class="p-6">
    <div class="mb-6">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item>Nueva Actividad</flux:breadcrumbs.item>
        </flux:breadcrumbs>
    </div>

    <div class="max-w-4xl">
        <div class="mb-6">
            <flux:heading size="xl" level="1">Nueva Actividad</flux:heading>
            <flux:subheading>Completa los detalles para publicar una nueva actividad comunitaria.</flux:subheading>
        </div>
        ...
        <form wire:submit="save" class="space-y-8">
            ...
            <div class="flex space-x-2 justify-end">
                ...
                <flux:button type="submit" variant="primary" wire:loading.attr="disabled">Publicar Actividad</flux:button>
            </div>
        </form>
    </div>
</div>
