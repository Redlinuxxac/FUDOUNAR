...
new #[Layout('layouts.app')] class extends Component {
    ...
    public function save()
    {
        ...
        Flux::toast('Curso actualizado correctamente.');
...
<div class="p-6">
    <div class="mb-6">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item>Editar Curso</flux:breadcrumbs.item>
        </flux:breadcrumbs>
    </div>
    ...
    <div class="max-w-5xl">
        <div class="mb-6">
            ...
            <flux:subheading>Modifica los detalles del programa educativo.</flux:subheading>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        >
                            ...
                            @elseif ($currentImage)
                                <img src="{{ $currentImage }}" class="w-full h-40 object-cover rounded-xl mb-2">
                                <p class="text-[10px] text-gray-400 italic text-center">Imagen actual (arrastra una nueva para cambiar)</p>
                            @else
